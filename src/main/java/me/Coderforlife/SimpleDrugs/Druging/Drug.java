...
public class Drug {
    ...
    public void loadDrugs() {
        try {
            ...
            for (JsonElement element : array) {
                ...
                setRecipeIngredient(shapedRecipe, 'A', MaterialFromArray(recipe, 0));
                setRecipeIngredient(shapedRecipe, 'B', MaterialFromArray(recipe, 1));
                setRecipeIngredient(shapedRecipe, 'C', MaterialFromArray(recipe, 2));
                setRecipeIngredient(shapedRecipe, 'D', MaterialFromArray(recipe, 3));
                setRecipeIngredient(shapedRecipe, 'E', MaterialFromArray(recipe, 4));
                setRecipeIngredient(shapedRecipe, 'F', MaterialFromArray(recipe, 5));
                setRecipeIngredient(shapedRecipe, 'G', MaterialFromArray(recipe, 6));
                setRecipeIngredient(shapedRecipe, 'H', MaterialFromArray(recipe, 7));
                setRecipeIngredient(shapedRecipe, 'I', MaterialFromArray(recipe, 8));
    ...
    private void setRecipeIngredient(ShapedRecipe recipe, char key, Material material) {
